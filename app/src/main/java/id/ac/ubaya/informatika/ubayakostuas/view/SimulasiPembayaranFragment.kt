...
import id.ac.ubaya.informatika.ubayakostuas.databinding.FragmentSimulasiPembayaranBinding
...
class SimulasiPembayaranFragment : Fragment() {
    ...
    private lateinit var dataBinding: FragmentSimulasiPembayaranBinding
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?,
    ): View? {
        // Inflate the layout for this fragment
        dataBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_simulasi_pembayaran, container, false)
...
//        }
    ...
    fun observeViewModel(){
        detailModel.kostLD.observe(viewLifecycleOwner, androidx.lifecycle.Observer{
            dataBinding.kost = it
        })
    }
}